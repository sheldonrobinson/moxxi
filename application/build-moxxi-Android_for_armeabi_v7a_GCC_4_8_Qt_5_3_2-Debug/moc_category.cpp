...
QT_MOC_LITERAL(9, 121, 10),
QT_MOC_LITERAL(10, 132, 8),
QT_MOC_LITERAL(11, 141, 4),
QT_MOC_LITERAL(12, 146, 12)
    },
    "Category\0categoryIdChanged\0\0parentidChanged\0"
    "nameChanged\0alternativesChanged\0"
    "removeAlternative\0alternative\0"
    "addAlternative\0categoryId\0parentid\0"
    "name\0alternatives"
};
...
void Category::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->parentidChanged(); break;
        case 2: _t->nameChanged(); break;
        case 3: _t->alternativesChanged(); break;
        case 4: { bool _r = _t->removeAlternative((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 5: { bool _r = _t->addAlternative((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Category::categoryIdChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (Category::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Category::parentidChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (Category::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Category::nameChanged)) {
                *result = 2;
            }
        }
        {
            typedef void (Category::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Category::alternativesChanged)) {
                *result = 3;
            }
        }
    }
...
int Category::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: *reinterpret_cast< QString*>(_v) = parentid(); break;
        case 2: *reinterpret_cast< QString*>(_v) = name(); break;
        case 3: *reinterpret_cast< QStringList*>(_v) = alternatives(); break;
        default: break;
        }
        _id -= 4;
...
// SIGNAL 0
void Category::categoryIdChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void Category::parentidChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 1, 0);
}

// SIGNAL 2
void Category::nameChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 2, 0);
}

// SIGNAL 3
void Category::alternativesChanged()
{
